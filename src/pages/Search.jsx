...
function Avatar({ src, name }) {
  ...
  if (src) return <img src={src} alt={name} className="w-16 h-16 rounded-full object-cover flex-shrink-0" />
  return (
    <div className="w-16 h-16 rounded-full bg-primary-100 text-primary-700 font-bold text-lg
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              {(CITIES[country] || CITIES.PT).map((c) => (
              ...
              <div key={p.id} className="card-hover flex flex-col">
                ...
                <div className="mt-4 flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-1 text-xs text-gray-400">
                    <MapPin className="w-3.5 h-3.5" />{p.city || 'Portugal'}
                  </div>
